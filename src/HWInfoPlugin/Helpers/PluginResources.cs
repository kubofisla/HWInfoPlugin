namespace Loupedeck.HWInfoPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.HWInfoPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.HWInfoPlugin.Resources.Resource.txt`.
